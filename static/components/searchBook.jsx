 ...
 render(){
   ...
   return <div className='searchBook'>
    ...
    <div className={"input-group "+bookSearchClassName}>
     <input type="text" className="form-control" placeholder="Search for a book title, author or ISBN.." name='searchBook' ref={(input)=>{this.searchInput=input}} onKeyPress = {this.handleSearch} / >
    ...
    <div className='checkOutButton'><button type = 'button' className = 'btn btn-primary' onClick={this.handleCheckout} disabled={this.state.borrowerId.length > 0 ? false : true}>Issue Book</button></div>
